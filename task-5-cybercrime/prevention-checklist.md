...
2. **Enable Two-Factor Authentication (2FA)**
   Turn on 2FA for email, social media, and banking apps to add an extra layer of security.

3. **Don’t click suspicious links**
   Avoid links from unknown emails, messages, or WhatsApp forwards—even if they look urgent or tempting.
...
Quick reporting can help recover lost money and prevent further fraud.
